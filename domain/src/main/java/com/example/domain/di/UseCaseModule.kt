...
abstract class UseCaseModule {
    ...
    @Binds
    @ViewModelScoped
    abstract fun bindGetAlbumTracksWithAlbumIdUseCase(getAlbumTracksWithAlbumIdUseCaseImpl: GetAlbumTracksWithAlbumIdUseCaseImpl): GetAlbumTracksWithAlbumIdUseCase
}